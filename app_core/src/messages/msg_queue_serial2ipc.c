...
//--------------------------------------------
#define MSG_QUEUE_SERIAL2IPC_SIZE          5
#define MSG_QUEUE_SERIAL2IPC_BUF_SIZEOF   (MSG_QUEUE_SERIAL2IPC_SIZE * sizeof(msg_serial2ipc_t))

//--------------------------------------------
static msg_queue_t msg_queue;
static uint8_t buffer[MSG_QUEUE_SERIAL2IPC_BUF_SIZEOF];
...
void msg_queue_serial2ipc_init(void)
{
	msg_queue_init(&msg_queue,
		buffer,
		sizeof(msg_serial2ipc_t),
		MSG_QUEUE_SERIAL2IPC_SIZE,
		MSG_QUEUE_SERIAL2IPC_MUTEX);
}
